...
//Event Listener that adds active classes to section and corresponding li in view and removes them from sections and corresponding li not in view
...
//Event Listener that displays the menu again when mouse moves and hides it after 3 seconds
